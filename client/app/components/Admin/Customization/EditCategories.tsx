...
const EditCategories = (props: Props) => {
  ...
  useEffect(() => {
    // Safely set categories only if data.layout.categories exists
  ...
  const editCategoriesHandler = async () => {
    // Safely access data.layout.categories with a fallback to an empty array
    const originalCategories = data?.layout?.categories || [];
    
    if (!areCategoriesUnchanged(originalCategories, categories) && 
