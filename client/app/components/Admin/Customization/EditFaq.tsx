...
const EditFaq = (props: Props) => {
  ...
  useEffect(() => {
    if (data?.layout?.faq) {
      ...
      setQuestions([]); // Initialize with an empty array if no FAQ data exists
    }
  ...
  const handleEdit = async () => {
    if (
      ...
      try {
        console.log("Submitting FAQ data:", questions);
        await editLayout({
          type: "FAQ",
          faq: questions,
        }).unwrap();
        ...
        console.error("Update failed:", mutationError);
        toast.error("Failed to update FAQ");
      }
    } else {
      console.log("No changes detected or some questions are empty.");
    }
  };
